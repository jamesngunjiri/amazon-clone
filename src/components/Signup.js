...
const Signup = () => {
  ...
  return (
    <Container>
      ...
      <FormInput onSubmit={handleCreateAccount}>
        ...
        />
        <p>
          <Spani>i</Spani> Passwords must have atleast 6 characters
        </p>
        ...
        <Spanlogin>
          ...
          <Link to="/login">
            <Spani2>Sign-In</Spani2>
          </Link>
        </Spanlogin>
        <p>
          Buying for work? <Spani2>Create a free business account</Spani2>
        </p>
      </FormInput>
    </Container>
  );
